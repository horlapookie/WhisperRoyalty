...
const command = {
    ...
    async execute(sock, msg, args, context) {
        ...
        // Get random profile pic from settings
        function getRandomProfilePic() {
            const pics = settings.profilePics;
            if (!pics || pics.length === 0) {
                return 'https://files.catbox.moe/mq8b1n.png'; // Fallback
            }
            return pics[Math.floor(Math.random() * pics.length)];
        }

        const helpMessage = `╔╭━━〔 *${botName.toUpperCase()}* 〕━━╮
│ ✦ *Mᴏᴅᴇ* : public
│ ✦ *Pʀᴇғɪx* : [ ${prefix} ]
│ ✦ *Usᴇʀ* : @${sender.split('@')[0]}
...
┃✪  group-admin promote @user - Promote member to admin
┃✪  group-admin demote @user - Demote admin to member
        ...
        await sock.sendMessage(from, {
            ...
            contextInfo: {
                ...
                externalAdReply: {
                    ...
                    body: 'Next-Generation WhatsApp Bot - 180+ Commands',
